...
class BuildingBlocks(BuildingBlocksInterface):
    ...
    def __setup_building_blocks__(self):
        ...
        self.screens['InterstitialScreen'] = \
            CommonChildScreen(self.test, 'InterstitialScreen', 'AdvertisingRootScreen', open_with_url_scheme=True)
        self.screens['InterstitialScreen'].set_screen_loading_timeout(5)
        self.screens['InterstitialOnceScreen'] = \
            CommonChildScreen(self.test, 'InterstitialOnceScreen', 'AdvertisingRootScreen', open_with_url_scheme=True)
